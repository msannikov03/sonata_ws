"""
Train PointCloudVAE on complete point clouds (point-cloud dataset mode).
"""
...
def parse_args():
    p = argparse.ArgumentParser(description="Train point cloud VAE")
    p.add_argument(
        "--data_path",
        type=str,
...
def main():
    ...
    for epoch in range(start, args.num_epochs):
        ...
        if va < best:
            ...
            save_checkpoint(
                path, model, opt, sch, epoch, best_val_loss=best, additional_info=extra
            )
